// src/utils/multilevelSpeaking.js
//
...
export const ML_LEVELS = ['below_A2', 'A2', 'B1', 'B2', 'C1'];
...
export const ML_CRITERIA = ['fluency', 'lexical', 'grammar', 'pronunciation'];

export const ML_CRITERION_LABEL = {
    fluency: 'Ravonlik',
...
export function normalizeMlLevel(level) {
...
export function scoreToMlLevel(score) {
 ...
 */
export function clampScoreToMlLevel(score, level) {
...
export function mlPositionInLevel(score, level) {
 ...
 */
export function aggregateMlSpeaking(criteria) {
...
export function mlAnswerSeconds(part, index = 0) {
