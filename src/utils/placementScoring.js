...
import { CEFR_ORDER, normalizeCefr } from './cefr.js';
 ...
 */
export function tallyByLevel(answers) {
    const tally = {};
 ...
 */
export function orderQuestionsByLevel(questions) {
