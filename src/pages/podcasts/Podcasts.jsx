...
export default function Podcasts() {
    ...
    return (
        <>
            ...
            <div className={`h-[100dvh] w-full flex flex-col font-sans overflow-hidden select-none transition-all duration-700 ${isDark ? 'bg-black text-white' : 'bg-zinc-50 text-zinc-900'} ${showSplash ? 'opacity-0 pointer-events-none scale-95' : 'opacity-100 scale-100'}`}>
