...
const AdminTestsToolbar = ({ 
    ...
    return (
        <header className={`h-16 border-b flex items-center justify-between px-6 shrink-0 transition-colors z-45 flex-wrap md:flex-nowrap gap-4 ${isDark ? 'bg-[#1e1e1e] border-white/5' : 'bg-white border-zinc-200'}`}>
            <div className="flex items-center gap-2.5 flex-1">
                ...
                {/* Search Box */}
                <div className="relative w-full max-w-[180px] shrink-0 group">
                ...
                <div className="h-5 w-px bg-zinc-250 dark:bg-white/10 mx-0.5 shrink-0" />
