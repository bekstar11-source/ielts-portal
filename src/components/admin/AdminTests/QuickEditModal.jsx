                        ...
                        {quickEditThumbnail && (
                            <div className="relative mt-3 rounded-xl overflow-hidden border border-zinc-200 dark:border-white/10 h-32 group">
                                ...
                                <button
                                    ...
                                    className="absolute top-2 right-2 p-1.5 rounded-full bg-black/60 hover:bg-black/80 text-white opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-200"
