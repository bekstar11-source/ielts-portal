...
function TeacherSidebar({ isOpen, setIsOpen }) {
    ...
    return (
        ...
        >
            {/* Logo */}
            <div className={`h-16 flex items-center px-4 border-b flex-shrink-0 ${isDark ? 'border-white/5' : 'border-gray-100'}`}>
            ...
            {/* Teacher Info */}
            <div className={`px-4 py-3 border-b flex items-center gap-3 overflow-hidden
