  ...
  return (
    <div className="space-y-6 pt-12 border-t border-warm-hairline dark:border-white/10" ref={collectionsSectionRef}>
        <div className="space-y-1">
            <h2 className="text-[32px] font-semibold text-warm-ink dark:text-warm-on-dark tracking-tight">Collections</h2>
                                ...
                                {collectionProcessedTests.fullTestsList.length > visibleCount && (
                                    <div className="flex justify-center items-center pt-10 pb-8">
                                        <button
                                            ...
                                            className="group relative flex items-center gap-3 px-8 py-3.5 bg-warm-ink hover:bg-black dark:bg-warm-on-dark dark:hover:bg-white dark:text-warm-ink text-white rounded-full font-semibold transition-all active:scale-95 text-[13px] shadow-sm"
                                        >
