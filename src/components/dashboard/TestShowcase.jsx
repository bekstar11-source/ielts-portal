    ...
    return (
        ...
        >
            ...
            <div className={isPremium ? 'opacity-60' : ''}>
                ...
                <div className="flex items-center gap-3 text-xs text-vetra-stone font-medium">
        ...
        <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="mb-10">
                <div className="flex items-center justify-between mb-6 px-1">
                    <div>
                        <h2 className="text-2xl font-bold text-vetra-midnight mb-1">Siz uchun tavsiyalar</h2>
                        <p className="text-vetra-stone text-sm">Sun'iy intellekt tanlagan testlar</p>
                    </div>
                    <div className="flex gap-2">
                        <button onClick={() => scroll('left')} className="p-2 rounded-xl bg-white border border-vetra-grey/60 text-vetra-midnight hover:bg-vetra-silver hover:border-vetra-orange/30 active:scale-95 transition">
                            <ChevronLeft size={20} />
                        </button>
                        <button onClick={() => scroll('right')} className="p-2 rounded-xl bg-white border border-vetra-grey/60 text-vetra-midnight hover:bg-vetra-silver hover:border-vetra-orange/30 active:scale-95 transition">
