...
export default function BottomNav({ activeTab, setActiveTab }) {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-[#09090b] border-t border-zinc-200 dark:border-zinc-800/80 z-[100] px-2 py-2 shadow-[0_-4px_16px_rgba(0,0,0,0.04)] pb-[safe-area-inset-bottom]">
