...
export default function StoriesContainer({ user, userData }) {
            ...
            <div className="flex gap-4 p-4 overflow-x-auto scrollbar-none animate-pulse">
                {[1, 2, 3, 4, 5].map(i => (
                    <div key={i} className="flex flex-col items-center gap-1.5 flex-shrink-0">
                        <div className="w-[77px] h-[77px] rounded-full bg-warm-surface dark:bg-white/10" />
                        <div className="w-14 h-3 bg-warm-surface dark:bg-white/10 rounded mt-0.5" />
                    </div>
                ))}
            </div>
        );
    ...
    return (
        <div className="w-full bg-warm-canvas dark:bg-warm-dark py-4 transition-colors">
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className={`p-[2px] rounded-full transition-transform duration-300 group-hover:scale-105 ${
                                ...
                                <div className="p-[2.5px] rounded-full bg-warm-canvas dark:bg-warm-dark">
                            ...
                            <span className="text-[11px] max-w-[78px] truncate text-warm-muted dark:text-warm-on-dark-soft font-medium select-none mt-0.5">
                                Admin
                            </span>
                        </button>
                    );
