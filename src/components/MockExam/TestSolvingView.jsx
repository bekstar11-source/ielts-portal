...
export const TestSolvingView = ({
    ...
    return (
        <div className={`flex flex-col h-[100dvh] bg-gray-50 overflow-hidden font-sans ${textSize}`} style={stage === 'writing' ? undefined : { userSelect: 'none', WebkitUserSelect: 'none' }}>
