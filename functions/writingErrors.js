// functions/writingErrors.js
//
// ⚠️ AVTOMATIK NUSXA — QO'LDA TAHRIRLAMANG.
// Manba: src/utils/writingErrors.js. O'zgartirish kiritish uchun o'sha faylni tahrirlang
...
const WRITING_ERROR_TYPES = [...GRAMMAR_TYPES, ...LEXICAL_TYPES, 'other'];

/** Promptga qo'yiladigan ro'yxat — AI faqat shulardan tanlashi kerak. */
const WRITING_ERROR_TYPE_LIST = [...GRAMMAR_TYPES, ...LEXICAL_TYPES].join(' | ');
 ...
 */
function canonicalWritingError(raw) {
...
module.exports = { WRITING_ERROR_TYPES, WRITING_ERROR_TYPE_LIST, canonicalWritingError };
