...
// Manba: src/utils/ieltsScoring.js. O'zgartirish kiritish uchun o'sha faylni tahrirlang
// va `npm run mirror` ni ishga tushiring.


const { canonicalQuestionType } = require("./questionTypes.js");
...
const collectQuestionNumbers = (node) => {
    const nums = new Set();
...
// buzilardi.
const hasSequentialLetterLabels = (choiceOptions) => {
...
const getOptionText = (opt, choiceOptions = null) => {
...
module.exports = { calculateBandScore, calculateOverallBand, normalizeString, isChoiceQuestionType, MULTI_SELECT_TYPES, isMultiAnswerType, getMultiSelectCount, getAnswerKey, getQuestionWeight, CONTAINER_KEYS, expandQuestionId, collectQuestionNumbers, isRomanNumeral, romanToInt, getNumeralPrefix, stripNumeralPrefix, getOptionLabel, hasSequentialLetterLabels, getOptionText, findOptionIndex, resolveOptionDisplay, checkAnswer, scoreMultiAnswer, evaluateTest, calculateSectionScore, formatTime };
