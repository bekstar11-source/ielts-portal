...
const QUESTION_FAMILY_LABEL_KEY = Object.fromEntries(
 ...
 */
function canonicalQuestionType(rawType) {
 ...
 */
function mergeTypeStats(target = {}, incoming = {}) {
  const out = { ...target };
...
module.exports = { QUESTION_FAMILIES, QUESTION_FAMILY_LABEL_KEY, canonicalQuestionType, mergeTypeStats };
