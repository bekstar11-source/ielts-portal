// functions/isoWeek.js
//
// ⚠️ AVTOMATIK NUSXA — QO'LDA TAHRIRLAMANG.
// Manba: src/utils/isoWeek.js. O'zgartirish kiritish uchun o'sha faylni tahrirlang
 ...
 * @returns {string[]}
 */
function lastWeekKeys(count, from = new Date()) {
  const keys = [];
...
module.exports = { TREND_WEEKS, isoWeekKey, weekKeyToMonday, lastWeekKeys };
